...
class SendMoneyConfirmation extends StatefulWidget {
  const SendMoneyConfirmation({super.key});

  @override
  SendMoneyConfirmationState createState() => SendMoneyConfirmationState();
}

class SendMoneyConfirmationState extends State<SendMoneyConfirmation> {
  @override
