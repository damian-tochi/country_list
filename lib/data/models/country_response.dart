...
import 'countries_list_response.dart';

List<CountryResp> countryRespFromJson(String str) => List<CountryResp>.from(json.decode(str).map((x) => CountryResp.fromJson(x)));

String countryRespToJson(List<CountryResp> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class CountryResp {
  ...
  factory CountryResp.fromJson(Map<String, dynamic> json) => CountryResp(
    ...
    coatOfArms: json["coatOfArms"] == null ? CoatOfArms(png: "", svg: ""): CoatOfArms.fromJson(json["coatOfArms"]),
